...
namespace HLU
{
    public class HluArcMapExtension //: IExtension, IExtensionConfig, IPersistVariant
    {
        ...
        //private Dictionary<string, esr/*i*/SQLPredicates> _sqlPredicates;
        ...
        private void SelectByQueryDef(QueryDef queryDef, string oidColumnAlias)
        {
        ...
        private void SelectByQueryFilter(QueryFilter queryFilter)
        {
        ...
        private void SelectByJoinMultiColumn(Table joinTable)
        {
            //RowCursor joinCursor = joinTable.Search(null, true);
            //Row joinRow;
        ...
        private string QuoteValue(Field field, object value)
        {
            //switch (field.Type)
            //{
        ...
        private void PipeSelection(Selection featureSelection)
        {
        ...
        private void CreateSelectionFieldList(string[] columns)
        {
            if (columns != null)
            {
                ...
                if ((_selectColumns == null) || (_selectColumns.Length != columns.Length))
                {
        ...
        private void ZoomSelectedCursor(QueryFilter queryFilter, int minZoom, string distUnits)
        {
        ...
        private void FlashFeature(QueryFilter queryFilter)
        {
            //if (_pipeData == null)
            ...
            //    // Bring ArcGIS into line by flashing all features twice
        ...
        private void SplitFeature(QueryFilter selectionQueryFilter,
            string lastToidFragmentID, string[] historyColumns)
        {
            //// make sure selection changed event handler won't intervene
            //_selectFieldOrdinals = null;
        ...
        private void MergeFeatures(QueryFilter resultFeatureQueryFilter,
            string newToidFragmentID, string[] historyColumns)
        {
            //// make sure selection changed event handler won't intervene
            //_selectFieldOrdinals = null;
        ...
        private int[] HistorySchema(string[] historyColumns)
        {
            ...
            var historyFields = from c in historyColumns
                                ...
                                select new
                                {
                                    ...
                                    FieldName = c.Replace(ArcMapApp.HistoryAdditionalFieldsDelimiter, String.Empty)
                                };
        ...
        private bool StartEditingWorkspace(bool editWS)
        {
        ...
        private bool IsShp(bool workspace)
        {
        ...
        //private bool CreateFieldsCollection(bool hasGeom, bool hasZ, bool hasM, object outWorkspace,
        //    esriGeometryType geometryType, int[] fieldLengths, string[] fieldNames, string[] fieldAliases,
        //    esriFieldType[] fieldTypes, bool[] fieldNullable, bool spatialReference)
        //{
        ...
        //public void AddFieldIndex(FeatureClass featureClass, String indexName, String fieldName)
        //{
        ...
        private bool CreateFeatureClass(string featureClassName, string configWord, object outWorkspace,
            bool fields, esriFeatureType featureType, esriGeometryType geometryType, bool CLSID, bool CLSEXT)
        {
        ...
        /// <returns></returns>
        public bool IsHluWorkspace(MapView maps)
        {
            //try
            //{
            //    IMap map = null;
        ...
        /// <returns></returns>
        private bool IsHluLayer(FeatureClass layer)
        {
            //try
            //{
                ////---------------------------------------------------------------------
        ...
        private int FuzzyColumnOrdinal(string fieldName)
        {
            if ((_hluFieldNames != null) && !String.IsNullOrEmpty((fieldName = fieldName.Trim())))
            {
                var q = from c in _hluLayerStructure.Columns.Cast<DataColumn>()
                        join s in fieldName.Split([ArcMapApp.HistoryAdditionalFieldsDelimiter],
