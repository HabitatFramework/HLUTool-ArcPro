...
namespace HLU.UI.UserControls.Toolbar
{
    ...
    internal class FilterByAttributesButton : Button
    {
        ...
        protected override void OnUpdate()
        {
            ...
            // Enable or disable the button based on CanFilterByAttributes and main window visibility.
            ...
            DisabledTooltip = "Unavailable when in bulk update mode, when there are no features to filter, or when the main window is not visible.";
        }
