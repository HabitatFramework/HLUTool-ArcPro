...
{
    /// <summary>
    /// Button implementation to register all selected new features under a single new INCID.
    /// </summary>
    internal class InsertFeatureSameIncidButton : Button
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public InsertFeatureSameIncidButton()
        {
        ...
        /// <summary>
        /// Initiates the insert-feature (same INCID) process. Called when the button is clicked.
        /// </summary>
