...
{
    /// <summary>
    /// Button implementation to register each selected new feature under its own new INCID.
    /// </summary>
    internal class InsertFeatureSeparateIncidButton : Button
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        public InsertFeatureSeparateIncidButton()
        {
        ...
        /// <summary>
        /// Initiates the insert-feature (separate INCIDs) process. Called when the button is clicked.
        /// </summary>
        protected override async void OnClick()
        {
            // Insert the features, with each feature getting its own new INCID.
            try
            {
                await _viewModel.InsertFeatureSeparateIncidsAsync();
            }
            catch (Exception ex)
            {
        ...
        protected override void OnUpdate()
        {
            ...
            Enabled = _viewModel.CanInsertFeatureSeparateIncid &&
