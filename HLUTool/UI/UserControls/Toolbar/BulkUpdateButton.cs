...
{
    /// <summary>
    /// Button implementation to start/stop the bulk update mode.
    /// </summary>
    internal class BulkUpdateButton : Button
    {
        #region Fields
        ...
        /// <summary>
        /// Start the bulk update mode. Called when the button is clicked.
        /// </summary>
