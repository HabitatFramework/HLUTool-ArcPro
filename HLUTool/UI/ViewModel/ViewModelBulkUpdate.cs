...
{
    class ViewModelBulkUpdate(ViewModelWindowMain_OLD viewModelMain,
        ...
        bool primaryHabitatChanged) : ViewModelBase, IDataErrorInfo
    {
        #region Fields

        private ViewModelWindowMain_OLD _viewModelMain = viewModelMain;

        private ICommand _okCommand;
        private ICommand _cancelCommand;
        private string _displayName = "Bulk Update";

        private bool _osmmBulkUpdateMode = osmmBulkUpdateMode;

        private bool _deleteOrphanBapHabitats = deleteOrphanBapHabitats;
        private bool _deletePotentialBapHabitats = deletePotentialBapHabitats;
        private bool _deleteIHSCodes = deleteIHSCodes;
        private bool _deleteSecondaryCodes = deleteSecondaryCodes;
        private int _sourceCount = sourceCount;
        private bool _createHistory = createHistory;
        private string _determinationQuality = determinationQuality;
